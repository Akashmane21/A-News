...
function Bolly(){
   localStorage.setItem("search","Bollywood");
}
function Sports(){
   localStorage.setItem("search","Cricket");
}function Politics(){
   localStorage.setItem("search","Politics");
}function Sppu(){
   localStorage.setItem("search","Sppu");
}function Tesla(){
   localStorage.setItem("search","Tesla");
}
...
<NavLink exact activeClassName = "active_class" to="/Search"> <button onClick={Bolly}>
   ...
   <NavLink exact activeClassName = "active_class" to="/Search"> <button onClick={Sports}>
   ...
   <h3>Sports</h3></center>
    ...
    <div class="first">
   <center>
   <NavLink exact activeClassName = "active_class" to="/Search"> <button onClick={Politics}>

   <Avatar src="https://www.idea.int/sites/default/files/Initiatives/2018-Theme-Money-in-Politics.png" />
   </button></NavLink><h3>Politics</h3></center>
   </div>
...
<div className="contents">
 ...
 <h3>Covid</h3></center>
    ...
    <div class="first">
   <center>
   <NavLink exact activeClassName = "active_class" to="/Search"> <button onClick={Tesla}>

   <Avatar src="https://1000logos.net/wp-content/uploads/2018/02/Emblem-Tesla.jpg" />
   </button></NavLink><h3>Tesla</h3></center>
   </div>
